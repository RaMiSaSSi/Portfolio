...

{
  ...
  solution:
    "Built a multi-vendor e-commerce platform with Angular, Spring Boot and PostgreSQL, covering product catalog management, order processing and payment handling, backed by a centralized admin dashboard and a REST API layer integrated across the fullstack architecture. A React Native mobile app lets customers browse and shop on the go.",
  features: [
